...
{
  using Lizzards.MvcToolkit.Core.Blocks;
  using Lizzards.MvcToolkit.Core.Blocks.Data;
  ...
  ///
  /// </summary>
  /// <seealso cref="Lizzards.MvcToolkit.Core.Blocks.Startup" />
  /// <autogeneratedoc />
  public sealed class DemoStartup : Startup
  {
      ...
      : base(env, configuration)
    {
      ...
      this.Apply(new AssembliesScanList("Lizzards.Mvctoolkit.Demo"));
    }
